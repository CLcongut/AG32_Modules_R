...
#define OLED_SCLK_Clr() GPIO_SetLow(GPIO4,GPIO_BIT1)//SCL  拉低
#define OLED_SCLK_Set() GPIO_SetHigh(GPIO4,GPIO_BIT1) //SCL  拉高
 
#define OLED_SDIN_Clr() GPIO_SetLow(GPIO4,GPIO_BIT2)//SDA  拉低
#define OLED_SDIN_Set() GPIO_SetHigh(GPIO4,GPIO_BIT2)  //SDA  拉高
